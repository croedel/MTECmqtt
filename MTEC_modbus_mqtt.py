...
def read_MTEC_data( registers ):
  ...
  try:
    ...
    pvdata["day_autarky"] = 100*(1 - (data["31001"]["value"] / pvdata["day_consumption"])) if pvdata["day_consumption"]>0 else 0
    pvdata["day_own_consumption"] = 100*(1-data["31000"]["value"] / data["31005"]["value"]) if data["31005"]["value"]>0 else 0
    ...
    pvdata["total_autarky"] = 100*(1 - (data["31104"]["value"] / pvdata["total_consumption"])) if pvdata["total_consumption"]>0 else 0
    pvdata["total_own_consumption"] = 100*(1-data["31102"]["value"] / data["31112"]["value"]) if data["31112"]["value"]>0 else 0
