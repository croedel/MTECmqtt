...
| day_autarky             | float | %    | Autarky rate today (*)
| day_own_consumption     | float | %    | Own consumption rate today (*)
...
| total_autarky           | float | %    | Autarky rate (*)
| total_own_consumption   | float | %    | Own consumption rate (*)
